"""
Django settings for money_senterjj_44821 project.
...
ROOT_URLCONF = 'money_senterjj_44821.urls'
...
WSGI_APPLICATION = 'money_senterjj_44821.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "money_senterjj_44821 API",
    "DESCRIPTION": "API documentation for money_senterjj_44821 App",
    "VERSION": "v1",
}
